...
from views import home,supplier_page,customer_page,delivery_page,weui_page, UserList, UserDetail, MenuList, MenuDetail, WalletList, WalletDetail, OrderList, OrderDetail, LocationList, LocationDetail, TestJoin
